...
export default function Toki() {
	return (
		<React.Fragment>
				...
				>
					...
					<CardBody className="mt-5 px-3">
						<p>
							...
							cuando queramos hablar acerca de cosas que
							ocurrieron en el pasado, cosas del estilo "antes,
							cuando estaba en la escuela..." o "cuando era
							joven", etc.
						</p>
						<p>
							Podremos usar la palabra とき、 para construir
							frases según los siguientes patrones:
						</p>
						...
						<p className="mt-5">
							Al igual que con casi todo lo demás, aquí también
							hay una fórmula mágica, pero antes de verla, hay que
							conocer las reglas para poder usarla.
						</p>
						<p className="mt-5">
							Podremos hacer uso de とき、 - toki、 en conjunto
							con los verbos, siempre y cuando éstos estén
							conjugados en 1 de 3 opciones:
						</p>
						<ol>
							<li>
								<p>
									Verbos en la Forma 辞書形 じしけい
									(jishokei).
								</p>
							</li>
							<li>
						...
						<p className="mt-5">
							Y por último, los sustantivos deberán estar
							conectados con la partícula「の」a la palabra「時、-
							とき、- toki、」
						</p>
						<p className="mt-5">
							Apartir de aquí hay 2 caminos, los verbos,
							adjetivos, y sustantivos conjugados en el tiempo{" "}
							<strong className="text-info">Presente</strong>,
							seguido por とき、.
						</p>
						<p>
						...
						<p>
							...
							indicando que <strong>una vez que terminó</strong>{" "}
							algo
							<strong>, ocurrió / ocurría</strong> otra cosa.
						</p>
						<p>
							Ambos en el <strong>Pasado</strong>, pero lo que
							viene antes de とき、ocurrió primero,{" "}
							<strong className="text-danger">y luego</strong>{" "}
							vino lo otro.
						</p>
						<h1 className="title text-center text-danger">
							¡Peligro!
						</h1>
						<p className="pb-5">
							La coma (、) en とき es{" "}
						...
						<h4 className="text-center text-info title">
							Los Verbos
						</h4>
						...
						<p>
							...
							<strong className="text-danger">+</strong> final de
							la oración{" "}
							<strong className="text-danger">en Pasado</strong>
							<br />
							<br />
							Equivaldrá a decir que{" "}
							<strong>mientras ocurría</strong> el verbo
						...
						<p>
							...
							<br />
							Equivaldrá a decir que{" "}
							<strong>una vez ocurrido</strong> el verbo
							<strong>, ocurrió</strong> lo otro.
						</p>
						...
						<p>
							...
							<br />
							Equivaldrá a decir que{" "}
							<strong>mientras ocurría</strong> el adjetivo
							<strong>, ocurría también</strong> lo otro.
						</p>
						...
						<p className="text-center">
							...
							resultados que con los verbos en sus distintas
							formas.
						</p>
						...
						<p>
							Sustantivos{" "}
							<strong className="text-danger">+</strong> の{" "}
							<strong className="text-danger">+</strong> とき、
							<strong className="text-danger">+</strong> final de
							la oración{" "}
							<strong className="text-danger">en Pasado</strong>
							...
							<br />
							Equivaldrá a decir que{" "}
							<strong>mientras ocurría</strong> el sustantivo
							<strong>, ocurría también</strong> lo otro.
						</p>
						<p className="text-center">
							<strong className="text-info">Nota:</strong> Si
			...
			<Secciones gruposTiempos={true} formasKei={true} />
		</React.Fragment>
	);
}
