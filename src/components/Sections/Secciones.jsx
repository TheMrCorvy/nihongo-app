		...
		<React.Fragment>
				...
				>
					...
					>
						<CardBody className="text-white text-capitalize">
							<span className="title">Hiragana　ひらがな</span>
			...
			<Col md="6">
				...
				>
					...
					>
						<CardBody className="text-white text-capitalize">
							<span className="title">Katakana　カタカナ</span>
							<i className="fas fa-chevron-right pl-3"></i>
							<br />
							<small>¿Cómo se escribe en Japonés?</small>
							<i
			...
			<Col md="6">
				...
				>
					<Card
						style={{
							borderRadius: "10px",
							boxShadow: "0px 5px 25px 0px rgba(26, 23, 77, 0.6)",
							background:
				...
				>
					...
					>
						<CardBody className="text-white">
							...
							<br />
							<small>
								Grupos de los verbos y adjetivos, y sus tiempos
							</small>
							<i
