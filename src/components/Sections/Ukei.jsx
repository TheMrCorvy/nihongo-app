...
export default function Ukei(props) {
	if (props.verbos) {
		return (
			<div className="col-lg-12 row justify-content-center" id="verbos-u">
				<h2 className="col-lg-12 text-center title">Verbos　う形</h2>
				<Col md="12">
					<Card
		...
		return (
			<div
				...
				id="adjetivos-u"
			>
				<h2 className="col-lg-12 text-center title">Adjetivos　う形</h2>
				<Col md="12">
					<Card
						style={{ borderRadius: ".5rem" }}
						className="bg-white card-plain px-3"
