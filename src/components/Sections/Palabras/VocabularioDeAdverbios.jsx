...
export default function VocabularioDeAdverbios() {
	return (
		<React.Fragment>
			<Col md="12">
				<Card
				...
				>
					...
					<CardBody className="mt-5 px-3">
						<p>
							...
							<strong>relatan historias</strong>". Los usaremos
							para hablar de cosas que nos dijeron, las creencias
						...
						<p>
							Éstos 3 verbos siempre finalizarán las frases,
							siendo precedidos por lo que estén relatando, es
							decir, primero diremos nuestra opinión, y luego
							vendrá <span id="omou1">思</span>う.
						</p>
						<UncontrolledTooltip
							placement="top"
							target="omou1"
						...
						<p>
							Al ser éstos los verbos que finalizan la oración,
							éstos mismos son los que marcarán el tiempo, y el
							tipo de discurso (
						...
						<p>
							Podremos preguntar por la opinión de alguien
							formulando la pregunta con{" "}
						...
						<p className="text-right">
							...
							すぎるよ！」
							<br />「
							<strong className="text-info">kangae</strong>
							sugiruyo!」
						</p>
						<UncontrolledTooltip
							placement="top"
