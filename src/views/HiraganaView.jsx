				...
				>
					<Row>
						...
						<Col md="6">
							...
							>
								<CardBody>
									...
									<p>
										La pronunciación es sumamente similar al
										español, con algunas adiciones. <br />{" "}
										En el caso de los sonidos con{" "}
										<strong>H</strong> (は、ひ、へ、ほ), se
										pronuncian usando lo que en español es
										el sonido de la <strong>J</strong>,{" "}
									...
									<p>
										...
										<strong>Y</strong>, (や、ゆ、よ), éstos
										se pronuncian como si tuvieran una{" "}
										<strong>I</strong> adelante, quedando
										parecido a decir "ia", "iu", "io".
									</p>
									<p>
										Generalmente es muy común ver que el
										hiragana す (su) se pronuncia sin la{" "}
										<strong>U</strong>, solo como una{" "}
										<strong>S</strong>. Ésto pasa mucho en
										las terminaciones です de las frases, o
										ます de verbos, por ejemplo.
									</p>
									<p>
										Y por último, pero no menos importante,
										queda じ, cuya pronunciación sonará más
										parecido a como suena la letra{" "}
							...
							>
								<CardBody>
									...
									<p>
										...
										(aunque realmente con los Katakanas se
										pueden "crear" sonidos nuevos, siguiendo
										ciertas reglas).
									</p>
								</CardBody>
							</Card>
						...
						<Col md="6">
							...
							>
								<CardBody>
									<h5 className="title pt-0">Excepciones</h5>
									<div className="progress-container progress-info pb-4">
										<Progress
											max="100"
											value="100"
									...
									<p>
										A éstas alturas te estarás preguntando
										"Qué pasó con ふ?", y lo que pasa es que
										es una excepción, ya que en lugar de
										leerse como "hu" igual que los demas en
										su fila, se lee más parecido a "fu"
										haciendo la{" "}
										<strong id="F-chat">F</strong> lo más
										suave posible.
									</p>
									<UncontrolledTooltip
										placement="top"
										...
										delay={0}
									>
										Easter egg: comparte "F en el chat" en
										alguna red social
									</UncontrolledTooltip>
									<p>
										El idioma japonés es uno basado en
										sílabas, de ésta forma, toda consonante
										debe estar acompañada por almenos una
										vocal, siendo la ん es la única
										excepción a ésta regla, ya que se
										pronuncia tal cual con el sonido de la
										letra "N".
									</p>
								</CardBody>
							</Card>
